...
class UpdateTool extends NullTool {
  ...
  public void mouseDown(MouseEvent e, int x, int y) {
    ...
    case 1: {
      editor.showStatus( "State change: Inspect archer and city" );
    ...
    case 7: {
      editor.showStatus( "State change: Inspect Red City at (1,1)" );
      game.setTileFocus(new Position(1,1));
      break;
    }
    case 8: {
      editor.showStatus( "State change: Inspect Blue City at (3,1)" );
      game.setTileFocus(new Position(3,1));
      break;
    }
    case 9: {
       editor.showStatus( "State change: Inspect empty tile at (0,0)" );
       game.setTileFocus(new Position(0,0));
       break;
     }
      case 10: {
        editor.showStatus( "State change: Change production in Red City to Caravan");
